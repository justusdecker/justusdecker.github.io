...
export default function FormularsMathOverview() {
  const [searchTerm, setSearchTerm] = useState('');

  const shortUrl = "Elekro-Ausbildung-Lernstoff/main/math/formulars/index.json";
            ...
            <div key={post.id} className="topic">
              <Link to={`/training-electrician/formulars-math/${post.id}`}>
                <div className="preview-box">
                  <MarkdownLoader 
                    url={`https://raw.githubusercontent.com/justusdecker/Elekro-Ausbildung-Lernstoff/main/math/formulars/${post.id}.md`} 
                  />
                </div>
              </Link>
